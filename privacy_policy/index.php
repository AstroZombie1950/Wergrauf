...
<head>
    ...
    <title>WERGRAUF | Обработка персональных данных</title>
    <meta name="description" content="Политика обработки персональных данных компании WERGRAUF. Условия, цели и порядок обработки персональных данных пользователей сайта.">
    <meta name="keywords" content="WERGRAUF">
	<meta name="robots" content="index, follow">
	<meta property="og:type" content="website">
	<meta property="og:title" content="Политика обработки персональных данных | WERGRAUF">
	<meta property="og:description" content="Условия, цели и порядок обработки персональных данных пользователей сайта.">
	<meta property="og:url" content="https://wergrauf.ru/privacy_policy">
    ...
    <div class="page-wrapper">
        ...
        <main class="container privacy-page">
            <section class="page-title">
                ...
                <p class="subtitle">
                    Настоящая политика обработки персональных данных определяет порядок и условия
            ...
            <section class="content-section">
                ...
                <p>
                    Настоящий документ разработан в соответствии с требованиями законодательства
                    Российской Федерации в области защиты и обработки персональных данных и
                ...
                <p>
                    ...
                    обработки персональных данных и условиями их обработки.
                </p>
            </section>
            ...
            <section class="content-section">
                ...
                <p>
                    В рамках использования сайта могут обрабатываться следующие персональные данные:
                </p>
                <ul>
            ...
            <section class="content-section">
                ...
                <ul>
                    ...
                    <li>исполнения обязательств перед клиентами;</li>
            ...
            <section class="content-section">
                <h2>4. Порядок обработки и хранения данных</h2>
                <p>
                    Обработка персональных данных осуществляется с использованием
                    автоматизированных и неавтоматизированных средств обработки.
                </p>
                <p>
                    Персональные данные хранятся не дольше, чем этого требуют цели их обработки,
                    если иные сроки хранения не установлены законодательством.
                </p>
            </section>
            ...
            <section class="content-section">
                ...
                <p>
                    ...
                    требование их уточнения, блокирования или уничтожения в случаях,
            ...
            <section class="content-section">
                ...
                <p>
                    ...
                    персональных данных от неправомерного доступа, утраты, изменения или раскрытия.
                </p>
            </section>
